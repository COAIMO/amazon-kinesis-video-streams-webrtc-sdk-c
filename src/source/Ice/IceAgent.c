...
STATUS updateSelectedLocalRemoteCandidateStats(PIceAgent pIceAgent)
{
    ...
    STRCPY(pIceAgent->rtcSelectedLocalIceCandidateDiagnostics.candidateType,
    ...
    // not applicable
    STRCPY(pIceAgent->rtcSelectedLocalIceCandidateDiagnostics.relayProtocol, STATS_NOT_APPLICABLE_STR);
    ...
    STRCPY(pIceAgent->rtcSelectedRemoteIceCandidateDiagnostics.candidateType,
